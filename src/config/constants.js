...
export const regionLabelDefault = 'Département';
...
export const regions = {
  ...
  BE: [
    { value: '1', label: 'Anvers' },
    { value: '2', label: 'Brabant flamand' },
    { value: '3', label: 'Brabant wallon' },
    { value: '31', label: 'Bruxelles-Capitale' },
    { value: '4', label: 'Flandre occidentale' },
    { value: '5', label: 'Flandre orientale' },
    { value: '6', label: 'Hainaut' },
    { value: '7', label: 'Li\u00e8ge' },
    { value: '8', label: 'Limbourg' },
    { value: '9', label: 'Luxembourg' },
    { value: '10', label: 'Namur' },
  ],
  CH: [
    { value: '1', label: 'Appenzell Rhodes Exterieures' },
    { value: '2', label: 'Appenzell Rhodes Interieures' },
    { value: '3', label: 'Argovie' },
    { value: '4', label: 'Bale-Campagne' },
    { value: '5', label: 'Bale-Ville' },
    { value: '6', label: 'Berne' },
    { value: '7', label: 'Fribourg' },
    { value: '8', label: 'Geneve' },
    { value: '9', label: 'Glaris' },
    { value: '10', label: 'Grisons' },
    { value: '11', label: 'Jura' },
    { value: '12', label: 'Lucerne' },
    { value: '13', label: 'Neuchatel' },
    { value: '14', label: 'Nidwald' },
    { value: '15', label: 'Obwald' },
    { value: '16', label: 'Schaffhouse' },
    { value: '17', label: 'Schwyz' },
    { value: '18', label: 'Soleure' },
    { value: '19', label: 'Saint-Gall' },
    { value: '20', label: 'Tessin' },
    { value: '21', label: 'Thurgovie' },
    { value: '22', label: 'Uri' },
    { value: '23', label: 'Valais' },
    { value: '24', label: 'Vaud' },
    { value: '25', label: 'Zoug' },
    { value: '26', label: 'Zurich' },
  ],
  CA: [
    { value: '1', label: 'Alberta' },
    { value: '2', label: 'Colombie-Britannique' },
    { value: '3', label: '\u00cele-du-Prince-\u00c9douard' },
    { value: '4', label: 'Manitoba' },
    { value: '5', label: 'Nouveau-Brunswick' },
    { value: '6', label: 'Nouvelle-\u00c9cosse' },
    { value: '7', label: 'Ontario' },
    { value: '8', label: 'Qu\u00e9bec' },
    { value: '9', label: 'Saskatchewan' },
    { value: '10', label: 'Terre-Neuve-et-Labrador' },
    { value: '11', label: 'Territoires du Nord-Ouest' },
    { value: '12', label: 'Nunavut' },
    { value: '13', label: 'Yukon' },
  ],
  LU: [
    { value: '1', label: 'Capellen' },
    { value: '2', label: 'Clervaux' },
    { value: '3', label: 'Diekirch' },
    { value: '4', label: 'Echternach' },
    { value: '5', label: 'Esch-sur-Alzette' },
    { value: '6', label: 'Grevenmacher' },
    { value: '7', label: 'Luxembourg' },
    { value: '8', label: 'Mersch' },
    { value: '9', label: 'Redange' },
    { value: '10', label: 'Remich' },
    { value: '11', label: 'Vianden' },
    { value: '12', label: 'Wiltz' },
  ],
  MU: [
    { value: '2', label: 'Agal\u00e9ga' },
    { value: '3', label: 'Cargados Carajos' },
    { value: '4', label: 'Flacq' },
    { value: '5', label: 'Grand Port' },
    { value: '6', label: 'Pamplemousses' },
    { value: '7', label: 'Plaines Wilhems' },
    { value: '1', label: 'Port-Louis' },
    { value: '8', label: 'Rivi\u00e8re du Rempart' },
    { value: '9', label: 'Rivi\u00e8re Noire' },
    { value: '10', label: 'Rodrigues' },
    { value: '11', label: 'Savanne' },
  ],
  MG: [
    { value: '1', label: 'Alaotra-Mangoro' },
    { value: '2', label: "Amoron'i Mania" },
    { value: '3', label: 'Analamanga' },
    { value: '4', label: 'Analanjirofo' },
    { value: '5', label: 'Androy' },
    { value: '6', label: 'Anosy' },
    { value: '7', label: 'Atsimo-Andrefana' },
    { value: '8', label: 'Atsimo-Atsinanana' },
    { value: '9', label: 'Atsinanana' },
    { value: '10', label: 'Betsiboka' },
    { value: '11', label: 'Boeny' },
    { value: '12', label: 'Bongolava' },
    { value: '13', label: 'Diana' },
    { value: '14', label: 'Haute Matsiatra' },
    { value: '15', label: 'Ihorombe' },
    { value: '16', label: 'Itasy' },
    { value: '17', label: 'Melaky' },
    { value: '18', label: 'Menabe' },
    { value: '19', label: 'Sava' },
    { value: '20', label: 'Sofia' },
    { value: '21', label: 'Vakinankaratra' },
    { value: '22', label: 'Vatovavy-Fitovinany' },
  ],
};
